...
## General Notes
The software is being developed on an Ubuntu 18.04.1 LTS Linux system operated through shared folders on an Oracle VirtualBox 5.2.8 r121009 ( Qt5.6.2) virtual machine. The virtual machine is running on a Lenovo Ideapad Flex 4 with Windows 10 Home Version 1809. 
...
str.contains(pat=[ACDEFGHIKLMNPQRSTVWY]{1}[1234567890]+[ACDEFGHIKLMNPQRSTVWY]{1}, regex=True)
fil = filtered_variant[filtered_variant.variant.str.contains(pat='[ACDEFGHIKLMNPQRSTVWY]{1}[1234567890]+[ACDEFGHIKLMNPQRSTVWY]{1}', regex=True)]
